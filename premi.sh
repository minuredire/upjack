...
date_list=$(date +"%Y-%m-%d" -d "$data_server")
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To Joys Tunneling ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green} Joys tunneling® ${NC}${YELLOW}(${NC} ${green} Joys Tunneling ${NC}${YELLOW})${NC}"
echo -e " © siapno kopimu${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/minuredire/jack/main/"
...
echo -e "   '=========================================='"
echo -e "     \e[1;32m1)\e[0m ♦️ Menggunakan Domain Pribadi"
echo -e "     \e[1;32m2)\e[0m ♦️ Menggunakan Domain SCRIPT"
echo -e "   =========================================="
...
clear
izinsc="https://raw.githubusercontent.com/minuredire/izin/main/ip"
# USERNAME
rm -f /usr/bin/user
...
<code>────────────────────</code>
<b> JOYS VPN STORE SCRIPT  </b>
<code>────────────────────</code>
<i>Automatic Notifications From Github</i>
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"t.me/dilanjaya"}]]}' 
...
wget -q https://raw.githubusercontent.com/minuredire/jack/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
echo -e "\e[96;1m          -[ JOYS TUNNELING PROJECT ]-                 \e[0m"
echo -e "\e[94;1m╚═════════════════════════════════════════════════╝\e[0m"
echo -e ""
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
